export default [
  {
    ...
    members: [
...

      {
        ...
        desc: 'BEX (浏览器扩展应用 CLI 模式), 网络产品和安全研究'
      },

      {
        ...
        desc: '管理我们的 Facebook 页面、博客和论坛。帮助处理文档、错误报告、外部系统，撰写和管理文章并提供社区支持。'
      },
